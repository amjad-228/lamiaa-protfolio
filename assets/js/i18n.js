    ...
    constructor() {
        ...
        this.translations = {
            ar: {
                ...
                // AWS cer
                'aws_page_title': 'شهاده احترافيه ممارس سحابي معتمد من AWS',
                'aws_org': 'AWS',
                'aws_cert_1_desc': 'تم ترسيخ أسس متينة في الحوسبة السحابية من خلال الحصول على اعتماد مهني دولي. لقد تم إتقان المفاهيم الجوهرية للسحابية ومعايير الأمان، كما تم التحقق من الكفاءة في استراتيجيات التشغيل والتسعير. يُعد هذا الإنجاز خطوة أساسية لضمان مواكبة التطورات التقنية المتسارعة.',


                // Qiyas Tests
                'qiyas_page_title': 'اختبارات قياس - لمياء العمري',
                'qiyas_org': 'قياس',
                'qiyas_cer2_title': 'اختبار قدرات الجامعيين',
